...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //String passangerName, passangerSurname, passangerDistrict, passangerCity, passangerAge, passangerIdentıtyNumber;
            ...
            //passangerIdentıtyNumber = Console.ReadLine();
            ...
            //Console.WriteLine("-----------------");
            //Console.WriteLine("Yolcu TC Kimlik Numarası: " + passangerIdentıtyNumber + " - Yolcu Ad Soyad: " + passangerName + " " + passangerSurname + " " +
            ...
            //Console.WriteLine();
            //Console.WriteLine("Sınav Ortalamınız: " + result);
            ...
            Console.WriteLine("Seçtiğininiz Cinsiyet: " + gender );
